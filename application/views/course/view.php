            ...
            <tbody>
             <?php foreach ($lessons as $lesson): ?>
                <tr>
                    ...
                    <td class="span4" ><a href="<?php echo $this->config->item('base_url'); ?>index.php/lesson/view/<?php echo $lesson->id; ?>"><?php echo $lesson->lesson_name;?></a></td>
